...
export default function MainContent() {
  ...
  const initialMeeting = {
    ...
    transcript: "Hello This is awesome",
    startTime: new Date(),
    meetingAction: "stop",
    summary: {
      start: new Date(),
      ...
      // first we get the microphone input from the browser (as a promise)...
       window.navigator.mediaDevices.getUserMedia({
          ...
          .catch(function (error) {
              console.error('There was an error streaming your audio to Amazon Transcribe. Please try again.');
              //toggleStartStop();
          });
  }
  ...
  const stopMeetingAction = (meeting) => {
    ...
    setMeeting((prevState) => {
      // Object.assign would also work
      return { ...prevState, startTime: meeting.startTime };
    });
    closeSocket();
  };
